...
function OAuth2Strategy(options, verify) {
  ...
  this._key = options.sessionKey || 'oauth2';
  ...
  this._hostField = options.hostField;
  this._authorizationPath = options.authorizationPath;
...
OAuth2Strategy.prototype.authenticate = function(req, options) {
  ...
  var oauth2 = new OAuth2(this._clientID,  this._clientSecret,
      'https://' + host, this._authorizationPath, this._tokenPath, this._customHeaders);
  ...
  if (req.query && req.query.code) {
    ...
    if (state) {
      ...
      var parsed = url.parse(oauth2._baseSite + oauth2._authorizeUrl, true);
